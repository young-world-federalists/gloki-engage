...
two-argument `.get(key, default)` on a Document**. AGENTS.md states this as the
...
AGENTS.md, verbatim: **"Contracts are immutable after deploy — new methods
...
ARCHITECTURE.md, AGENTS.md, MASTER_TODO.md §4, and `git show 963170d`.
